...
//!
//! Calls a small Kotlin object (`org.clispeak.app.Speech`) rather than
...
const SPEECH_CLASS_NAME: &str = "org/clispeak/app/Speech";
...
const INVITES_CLASS_NAME: &str = "org/clispeak/app/Invites";
...
const BATTERY_CLASS_NAME: &str = "org/clispeak/app/Battery";
